...
import 'dart:async';
import 'dart:io';
import 'package:pacman/models/ghost.dart';
import 'package:pacman/models/path.dart';
import 'package:pacman/models/pixel.dart';
import 'package:pacman/models/player.dart';
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          color: Color.fromARGB(255, 111, 172, 234),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        padding: const EdgeInsets.symmetric(
